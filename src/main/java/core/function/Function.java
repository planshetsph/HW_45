...
public class Function {
	...
	static By el_06 = By.id("id_f_label_fn"); // signup
	static By el_07 = By.id("id_fname"); // signup
	static By el_08 = By.id("id_f_label_ln"); // signup
	static By el_09 = By.id("id_lname"); // signup
	static By el_10 = By.id("id_f_label_ea"); // signup
	static By el_11 = By.id("id_email"); // signup
	static By el_12 = By.id("id_f_label_pn"); // signup
	static By el_13 = By.id("id_phone"); // signup
	static By el_14 = By.id("id_rb_label_g"); // signup
	...
	static By el_19 = By.id("id_f_label_s"); // signup
	static By el_20 = By.id("id_state"); // signup
	static By el_21 = By.xpath("//*[@id='id_state']/option[6]"); // signup
	static By el_22 = By.id("id_cb_label_t"); // signup
	static By el_23 = By.id("id_terms"); // signup
	...
	static By el_31 = By.id("copyright"); // signup
	...
	public static void main(String[] args) {
		System.out.println("Function Framework");
