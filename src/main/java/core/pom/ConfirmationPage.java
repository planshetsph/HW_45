...
public class ConfirmationPage implements Constant {

	public static void test() {
		Common.url = "http://alex.academy/exe/signup/v1/confirmation.php";
		...
		System.out.println("43. Element [Back (button)]: " + (Common.isVisible(el_43) ? "Visible" : " Not visible")); // signup
		Common.driver.quit();
	}
